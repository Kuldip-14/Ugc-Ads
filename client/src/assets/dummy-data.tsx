...
export const featuresData = [
    {
        ...
        title: 'Smart Upload',
        desc: 'High-quality design and scalable development focused on perfromace and usability.'
    },
    {
        icon: <ZapIcon className="w-6 h-6" />,
        title: 'Instant Generation',
        desc: 'Optiomized models deliver output in seconds with great fidelity.'
    },
    {
...
export const faqData = [
    {
        ...
        answer: 'We leverage state-of-the-art diffusion models trained on millions of product images to blend your product into realistic scenes while preserving details, lighting and refelctions.'
    },
    {
    ...
    {
        question: 'What input fromats do you support?',
