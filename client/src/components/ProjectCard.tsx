...
const ProjectCard = ({gen, setGenerations, forCommunity = false} : {gen: Project, setGenerations: React.Dispatch<React.SetStateAction<Project[]>>, forCommunity?: boolean}) => {
  ...
  return (
    <div key={gen.id} className = "mb-4 break-inside-avoid">
      <div className = "group bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition">
      {/* Preview */}
          ...
          {/* Product Description */}
              {gen.productDescription && (
                   <div className = "mt-3">
                    ...
                    <div className="text-sm text-gray-300 bg-white/3 rounded-md wrap-break-word">
                      {gen.productDescription}</div>
                   </div>
              )}
